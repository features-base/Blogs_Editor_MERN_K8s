    ...
    return (
        <div className='doc about vertical-align'>
            ...
            <div className='doc-content'>
                ...
                <div className='title h1'>Articles</div>
                <div className='body'>
                ...
                <div className='title h3'>Security and Privacy</div>
                <div className='body'>
                ...
                <div className='title h3'>Performance and Caching</div>
                <div className='body'>
                ...
                <div className='title h3'>Design Patterns and Coding Standards</div>
                <div className='body'>
                ...
                <div className='title h3'>Deployment and Containerization</div>
                <div className='body'>
